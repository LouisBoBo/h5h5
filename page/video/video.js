$(function () {
    var mp4 = localStorage.getItem('playmp4');
    console.log('^^^^^^^^^^^^^^' + mp4);
    //对url进行编码
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            //配置自定义分享内容
            var title = "点击领取免费会员资格👆";
            var desc = "这是衣蝠官方为回馈用户提供的福利,限时免费，快来领取💰💰";
            var link = shareUrl;
            var imgUrl = "https://www.incursion.wang/small-iconImages/heboImg/shareH5_test.jpg";
            wx.ready(function () {
